...
function getTitle(attribute) {
    var titles = [
		...
		{ "attribute": "Damage dealt", "title": "Additional damage multiplier target receives caused by the attacker, it doesn't affect hitbox damage on KB calculation" },
